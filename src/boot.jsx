...
// NOTE: this module is loaded via a DYNAMIC import from main.jsx so that any
// throw during evaluation of this file or its import graph rejects the import()
// with the REAL Error (message + stack) instead of WebKitGTK's cross-origin
// "Script error." mask. See main.jsx + NOVA-LINUX-PROGRESS.md.
...
log.info('boot: boot.jsx start — tauri bridge =', hasTauri, '| lite(url) =', isLiteMode());
