...
export function AtlasApp({ AC, showToast }) {
  ...
  const ghost = { padding: "8px 12px", borderRadius: 8, border: "1px solid var(--nv-border)", background:"var(--nv-elevated)", color: "var(--nv-text)", cursor: "pointer", fontFamily: FFB, fontWeight: 600, fontSize: 13, lineHeight: 1, whiteSpace: "nowrap" };
