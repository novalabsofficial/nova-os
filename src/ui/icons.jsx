...
export function NovaSvgIcon({ id, size = 26 }) {
  ...
  if(id==="photos")return(<svg width={w} height={h} viewBox="0 0 32 32"><defs><linearGradient id="photos-sky" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#fef3c7"/><stop offset="100%" stopColor="#fbbf24"/></linearGradient><radialGradient id="photos-hl" cx="20%" cy="20%" r="80%"><stop offset="0%" stopColor="white" stopOpacity="0.16"/><stop offset="60%" stopColor="white" stopOpacity="0"/></radialGradient></defs>{/* Classic "photograph" iconography — landscape silhouette with sun.
        Reads instantly as "image / photo" at any size. Warm yellow sky base. */}<rect width="32" height="32" rx={r} fill="url(#photos-sky)"/><rect width="32" height="32" rx={r} fill="url(#photos-hl)"/>{/* Sun */}<circle cx="10.5" cy="11" r="2.8" fill="white"/>{/* Mountain silhouette across the bottom */}<path d="M0 32 L0 22 L8 14 L13 19 L18 12 L22 16 L27 11 L32 17 L32 32 Z" fill="#0e7490"/>{/* Foreground darker layer */}<path d="M0 32 L0 26 L6 22 L11 25 L17 21 L24 24 L32 22 L32 32 Z" fill="#155e75" opacity="0.85"/></svg>);
